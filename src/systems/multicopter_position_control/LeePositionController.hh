...
namespace multicopter_control
{
  ...
  /// controller
  struct LeePositionControllerParameters
  {
  ...
  {
    /// \brief Factory function to create LeePositionController objects
    ...
    /// pointer to an instance of LeePositionController
    public: static std::unique_ptr<LeePositionController> MakeController(
    ...
    private: LeePositionControllerParameters controllerParameters;
