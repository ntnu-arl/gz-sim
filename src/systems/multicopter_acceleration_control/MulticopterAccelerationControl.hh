 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_MULTICOPTERACCELERATIONCONTROL_HH_
#define GZ_SIM_SYSTEMS_MULTICOPTERACCELERATIONCONTROL_HH_
...
namespace systems
{
  ...
  /// system on each rotor. Note also that only one MulticopterAccelerationControl
  ...
  ///
  class MulticopterAccelerationControl
      : public System,
        public ISystemConfigure,
        public ISystemPreUpdate
  {
    /// \brief Constructor
    public: MulticopterAccelerationControl() = default;
    ...
    private: std::string commandSubTopic{"cmd_acc"};
    ...
    private: std::unique_ptr<multicopter_control::LeeAccelerationController>
    ...
    private: std::optional<msgs::Twist> cmdAccMsg;

    /// \brief Maximum commanded linear acceleration
    private: math::Vector3d maximumLinearAcceleration;

    /// \brief Maximum commanded angular velocity
    private: math::Vector3d maximumAngularVelocity;

    /// \brief Mutex for cmdAccMsg
    private: std::mutex cmdAccMsgMutex;
