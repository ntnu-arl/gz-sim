...
#ifndef GZ_SIM_SYSTEMS_MULTICOPTER_CONTROL_LEECONTROLLER_HH_
#define GZ_SIM_SYSTEMS_MULTICOPTER_CONTROL_LEECONTROLLER_HH_
...
namespace multicopter_control
{
  ...
  struct LeeControllerParameters
  {
    ...
    Eigen::Vector3d maxLinearVelocity;
    Eigen::Vector3d maxAngularVelocity;
  ...
  class LeeController
  {
    /// \brief Factory function to create LeeController objects
    ...
    /// pointer to an instance of LeeController
    public: static std::unique_ptr<LeeController> MakeController(
    ...
    /// \brief Position gain normalized by the inverse of the mass
    private: Eigen::Vector3d normalizedPositionGain;
