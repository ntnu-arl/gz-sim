...
#include "MulticopterAttitudeControl.hh"
...
//////////////////////////////////////////////////
void MulticopterAttitudeControl::Configure(const Entity &_entity,
    ...
    EventManager &/*_eventMgr*/)
{
  ...
  {
    gzerr << "MulticopterAttitudeControl plugin should be attached to a model "
  ...
  {
    gzerr << "Please specify velocityGain for MulticopterAttitudeControl.\n";
    return;
  }
  ...
  {
    gzerr << "Please specify attitudeGain for MulticopterAttitudeControl.\n";
    return;
  }
  ...
  {
    gzerr << "Please specify angularRateGain MulticopterAttitudeControl.\n";
    return;
  }
  ...
  this->attitudeController = LeeAttitudeController::MakeController(
      controllerParameters, vehicleParams);

  if (nullptr == this->attitudeController)
  {
    gzerr << "Error while creating the LeeAttitudeController\n";
    return;
  }
  ...
  this->node.Subscribe(enableTopic, &MulticopterAttitudeControl::OnEnable,
                       this);
  gzmsg << "MulticopterAttitudeControl subscribing to Boolean messages on ["
...
//////////////////////////////////////////////////
math::Inertiald MulticopterAttitudeControl::VehicleInertial(
...
//////////////////////////////////////////////////
void MulticopterAttitudeControl::PreUpdate(
    const UpdateInfo &_info,
    EntityComponentManager &_ecm)
{
  GZ_PROFILE("MulticopterAttitudeControl::PreUpdate");
...
//////////////////////////////////////////////////
void MulticopterAttitudeControl::OnEnable(
...
//////////////////////////////////////////////////
void MulticopterAttitudeControl::PublishRotorVelocities(
    EntityComponentManager &_ecm,
...
GZ_ADD_PLUGIN(MulticopterAttitudeControl,
                    System,
