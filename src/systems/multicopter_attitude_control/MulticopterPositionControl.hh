 ...
 *
 */
#ifndef GZ_SIM_SYSTEMS_MULTICOPTERPOSITIONCONTROL_HH_
#define GZ_SIM_SYSTEMS_MULTICOPTERPOSITIONCONTROL_HH_
...
namespace systems
{
  ...
  /// system on each rotor. Note also that only one MulticopterPositionControl
  ...
  {
    /// \brief Constructor
    public: MulticopterPositionControl() = default;
    ...
    /// \brief Current command pose. This pose is a reference pose
    /// from which, the controller will try to maintain position and yaw. A command of zeros must be
